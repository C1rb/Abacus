...
root = Tk()
root.title("Abacus")
root.geometry("163x349+550+200")
root.configure(bg = "grey")
root.resizable(False, False)
root.attributes("-topmost", 1)
#root.iconbitmap("C:/Users/Person/Images/Python Tkinter Icon/Abacus.ico") #There is no icon for this program in order to add an icon open and read ICON.md

#Entry widget
e = Entry(root, width = 17, font=("Consolas 14 bold"))
e.grid(row = 0, column = 1, columnspan = 10, ipady = 10)
...
#Operator buttons
button_dec = Button(root, borderwidth = 8, padx = 0, pady = 0, text = ".", height = 2, width = 5, command = lambda: click(".", e)).grid(row = 5, column = 3)
button_equal = Button(root, borderwidth = 8, padx = 0, pady = 0, text = "=", height = 2, width = 5, command = equal).grid(row = 1, column = 3, columnspan = 3)
button_clear = Button(root, borderwidth = 8, padx = 0, pady = 0, text = "C", height = 2, width = 13, command = clear).grid(row = 1, column = 1, columnspan = 2)

button_add = Button(root, borderwidth = 8, padx = 0, pady = 0, text = "+", height = 2, width = 5, command = lambda: click("+", e)).grid(row = 5, column = 2)
button_minus = Button(root, borderwidth = 8, padx = 0, pady = 0, text = "-", height = 2, width = 5, command = lambda: click("-", e)).grid(row = 6, column = 2)
button_times = Button(root, borderwidth = 8, padx = 0, pady = 0, text = "*", height = 2, width = 5, command = lambda: click("*", e)).grid(row = 6, column = 1)
button_divide = Button(root, borderwidth = 8, padx = 0, pady = 0, text = "/", height = 2, width = 5, command = lambda: click("/", e)).grid(row = 6, column = 3)
